        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			<div class="show-top-grids">
				<div class="col-sm-8 single-left">
					<div class="song">
						<div class="song-info">
							<h3>Watch my lates video</h3>	
					</div>
						<div class="video-grid">
							<iframe src="../cleanbusiness/video/13770702_292985354387799_1920640637_s.mp4" allowfullscreen></iframe>
						</div>
					</div>
					<div class="song-grid-right">
						<div class="share">
							...
							<ul>
							  ...
							  <li><a href="#" class="icon like">200 </a></li>
								<li><a href="#" class="icon comment-icon">13</a></li>
					...
					<div class="published">
						<script src="jquery.min.js"></script>
							...
							<div class="load_more">	
								<ul id="myList">
									<li>
										<h4>Posted by <a href="#">Ubong Attah</a> on 35mins ago</h4>
					...
					<div class="all-comments">
						<div class="all-comments-info">
							...
							<div class="all-comments-buttons">
								<ul>
									<li><a href="#" class="top">Comments</a></li>
						...
						<div class="media-grids">
							<div class="media">
								...
								<div class="media-body">
									...
									<span> 45mins ago<!--<a href="#"> Admin </a>--></span>
								</div>
							</div>
							<div class="media">
								<h5>Mark Johnson</h5>
                ...
                <div class="col-md-4 single-right" style="height:300px; background-color:#FFF">
                <h3 style="background-color: #21DEEF; padding: 5px; color:#FFF">Adverts</h3>
                <div class="smalladv">Content for  class "300 x 200px" Goes Here</div>
              ...
              <div class="col-md-4 single-right" style="height:650px; background-color:#FFF">
                <h3 style="background-color: #21DEEF; padding: 5px; color:#FFF">Adverts</h3>
                <div class="adv">Content for  class "450 x 150px" Goes Here</div>
