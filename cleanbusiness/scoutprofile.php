...
<div class="wrapper"> 
  ...
  <div class="onediv" style="border-top:dotted 1px #333333; margin-top:10px;">
      <div class="profilediv">
        <div class="profdiv1">Year(s) of experience:</div>
        <div class="profdiv2">5</div>
      </div>
      <div class="profilediv">
        <div class="profdiv1">Position:</div>
        <div class="profdiv2">3</div>
      </div>
  ...
  <div class="clear" style="text-align:right;"><a href="scouteditprofile.php">Edit profile</a></div>
  <!-- ####################################################################################################### -->
