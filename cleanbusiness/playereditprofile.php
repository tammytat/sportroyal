...
<head>
<title>SportRoyal | Edit Profile</title>
...
<div class="wrapper"> 
    ...
    <div id="topnav">
      <ul>
        <li><a href="home.php">Home</a></li>
         <li class="active"><a href="playereditprofile.php">Edit Profile</a></li>
        
        <li class="last"><a href="index.php">Signout</a></li>
      </ul>
    </div>
    <br class="clear" />
  </div>
  ...
  <form>
    ...
    : Player</h1>
    <div class="regdiv">
    <iframe name="regframe" class="framedivbox" src="playerreg2.php">
