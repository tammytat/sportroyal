...
<div class="wrapper"> 
  ...
  <div id="topbar">
    <div class="fl_left">
      <p>Tel: +234813 267 3197 | Mail: info@sportroyal.com</p>
  ...
  <div id="homecontent">
    ...
    <form>
        <fieldset style="margin:0px; padding:20px; border:1px solid #666; width:70%; margin-left:auto; margin-right:auto;">
        <legend  style="width:200px; margin-bottom:0px;">
        Signin to SportRoyal</legend>
        <div class="warning2 invalid">wrong password/username
        </div>
          <div class="lefty22" >
           <div class="boxy22" style="width:22%; float:left">Email address
          </div>
          <div class="boxy21"><input name="Surname" type="text" required size="50" placeholder="Enter your email address">   
          </div>
          </div>
          <div class="lefty22" >
           <div class="boxy22" style="width:22%; float:left">Password
          </div>
          <div class="boxy21"><input name="Surname" type="password" required size="50"  placeholder="Enter your password">  
          </div>
          </div>
          <div class="lefty22">
          
            <div class="boxy22" style="width:25%; padding-bottom:0px; float:left"> <input type="checkbox" name="checkbox" id="checkbox">
            <label for="checkbox" style="clear:both">Remember me</label>  </div>
       <div class="boxy21" style=" width:70%;">
         <a href="Register.php">Create account</a> </div>
             </div>
          <div class="lefty22">
          <center>
          <input type="submit" value="Login to account" formaction="home.php">
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
