...
<head>
<title>Sport Royal | Contact Us</title>
...
<div class="wrapper"> 
  ...
  <div class="contactheader">
    <div class="headercontact">Contact Us</div>
  
  <form>
    <div class="contactheader22">
      <div class="leftheader1">Email</div>
      <div class="header223"><input name="" type="text" size="50" placeholder="enter email address"  required="required"/></div></div>
      <div class="secondheader">
        <div class="firstheader1">Comments</div>
        <div class="firstheader2">
        <textarea name="" cols="50" rows="3" placeholder="enter your comments"  required="required"></textarea>
        </div>
      
      
      
      </div>
      <div class="contactdiv"><center><input name="" type="submit" value="Submit Form" /> &nbsp;&nbsp;&nbsp;&nbsp; <input type="reset" value="Cancel Form" /></center></div>
  ...
  <div class="contactheader2"><br/><br/><br/><br/><br/><br/>
  Facebook: sportroyal<br/>
  Twitter: @sportroyal<br/>
  
  <span class="glyphicon glyphicon-envelope"></span>&nbsp;&nbsp;info@sportroyal.com<br/>
<span class="glyphicon glyphicon-phone-alt"></span>&nbsp;&nbsp;+2347065148570<br/><br/>
